...
/**
 * Created by PhanVanTrung on 2016/07/03.
 */
public class SearchLibTest {

    public static void testJapanese(String searchText) {
        List<SearchDataRecord> searchData = createDataTest();
        TestSearchData.searchingLanguage = SearchLib.LANG_CODE_JAPANESE;
    ...
    public static void testEnglish(String searchText) {
        List<SearchDataRecord> searchData = createDataTest();
        TestSearchData.searchingLanguage = SearchLib.LANG_CODE_ENGLISH;
        List<SearchDataRecord> searchResult = moreco.eas.evolable.asia.moreco.searchtext.moreco.searchlib.SearchLib.search(searchText, moreco.eas.evolable.asia.moreco.searchtext.moreco.searchlib.SearchLib.LANG_CODE_ENGLISH, searchData, 0);
        for (int i = 0; i < searchResult.size(); i++) {
            System.out.println(searchResult.get(i).getSearchData());
        }
    }

    public static List<SearchDataRecord> createDataTest(String[] testDataEn, String[] testDataJa) {
        List<SearchDataRecord> result = new ArrayList<SearchDataRecord>();
        for (int i = 0; i < testDataEn.length; i++) {
            result.add(new TestSearchData(testDataEn[i], testDataJa[i]));
        }

        return result;
    }

    public static List<SearchDataRecord> createDataTest() {
        String[] testDataEn = {
        ...
        return createDataTest(testDataEn, testDataJa);
    }

    /**
     * Data model used for testing.
     */
    public static class TestSearchData implements SearchDataRecord {
        public static String searchingLanguage = SearchLib.LANG_CODE_ENGLISH;
        ...
        public String getSearchData() {
            return SearchLib.LANG_CODE_ENGLISH.equals(searchingLanguage) ? textEn : textJa;
        }
    }
}